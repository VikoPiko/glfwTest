...
namespace test
{
          ...
          m_View(glm::translate(glm::mat4(1.0f), glm::vec3(0, 0, 0)))
	{
        ...
        float positions[] =
        {
            -50.0f,-50.0f, 0.0f, 0.0f,// each line is a vertex
             50.0f,-50.0f, 1.0f, 0.0f,
             50.0f, 50.0f, 1.0f, 1.0f,
            -50.0f, 50.0f, 0.0f, 1.0f,

             150.0f,-50.0f, 0.0f, 0.0f, //more vertecies to enable for batch rendering
        ...
        m_Texture = std::make_unique<Texture>("res/textures/daco.png");
